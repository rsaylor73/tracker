<form name="myform" action="/save_xml" method="POST" enctype="multipart/form-data">
...
<div class="modal-body">
    ...
    <div class="row top-buffer">
    	<div class="col-sm-6">XML File:</div>
    	<div class="col-sm-6"><input type="file" name="xml_file" class="form-control"></div>
    </div>
